...
sina_news_df = news_crawler.get_latest_news('sina', top=6000, show_content=True)
sohu_news_df = news_crawler.get_latest_news('sohu', top=1000, show_content=True)
xinhuanet_news_df = news_crawler.get_latest_news('xinhuanet', top=1000, show_content=True)
...
news_df = preprocessing.get_data(news_df, last_time='2018-04-06 23:59', delta=5)
